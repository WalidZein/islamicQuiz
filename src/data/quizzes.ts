...
const quizzes: Quiz[] = [
  ...
  },
  {
    id: 47,
    released: true,
    timeOfRelease: "2024-12-30T13:00:00Z",
    seasonId: 2,
    questions: [
      {
  ...
  },
  {
    id: 50,
    released: true,
    timeOfRelease: "2025-01-02T13:00:00Z",
    seasonId: 2,
    questions: [
      {
  ...
  },
  {
    id: 61,
    released: true,
    timeOfRelease: "2025-03-25T13:00:00Z",
    seasonId: 2,
    questions: [
      {
        question: "العقيدة هي علم غيبي غير منظور فلذلك هو يؤخذ",
        type: QuestionType.SINGLE,
        options: ["بالعقل و النقل معا.", "ما أخبرنا به الله عز وجل عن طريق كتابه و بوحيه إلى الرسول ﷺ (النقل).", "من النقل بعد تلقينه بحجج و براهين من علم الكلام و الفلسفة"],
        correctAnswerIndex: [1],
        explanation: "",
      },
      {
        question: "أين يجد المسلم إجابات عن الأسئلة الوجودية؟",
        type: QuestionType.SINGLE,
        options: ["في كتب الأحياء والعلوم التجريبية وعلم الكلام", "عند العلماء المسلمين الذين جمعوا بين مفهومهم الديني وعقيدتهم وبين حضارة الغرب وعلومهم وفلسفتهم.", "في علم الأصول الستة"],
        correctAnswerIndex: [1],
        explanation: "",
      },
      {
        question: "من هو مرتكب الكبيرة عند السلف (أيّد الإجابة بدليل أو أكثر من الكتاب أو السنة)",
        type: QuestionType.SINGLE,
        options: ["كافر بفعله كبيرة أو صغيرة", "مؤمن بإيمانه فاسق بكبيرته", "مؤمن إيمان مطلق"],
        correctAnswerIndex: [1],
        explanation: "",
      },
      {
        question: "من أدلة الخوارج على تكفير مرتكب الكبيرة (وهذا ما أنكره عليهم السلف الصالح)",
        type: QuestionType.SINGLE,
        options: ["جعلوا العمل شرطًا للإيمان فمن لا يعمل كفر", "افترضوا أن الفسق والظلم كفر، وهذا فهم خاطئ", "الاثنان معًا"],
        correctAnswerIndex: [2],
        explanation: "",
      },
    ],
